...
### Off-road and boundaries (Adam, 23 Sept 2026: "replace our invisible-wall stumps with real off-road terrain and physical boundaries for a truer Mario Kart feel")
Mario Kart lets you leave the road: grass, sand or mud slows you, and walls stand only where they belong. Ours: on Harbor Loop, Meadow Run, Canyon Rush and Frostbite Pass a 6 m band of off-road runs past the curb (the dirt top-speed cap, 70 %, ignored while boosting or airborne, so a boosted corner cut pays), painted as the place's ground (beach sand, grass, sand, snow), ending at a real continuous boundary (a stone sea wall, a clipped hedge, a sandstone wall, a snowbank). Boardwalk Nights (a pier) and Skyline Circuit (a sky road) keep their edge at the curb, with a continuous rail through the posts (neon, gold). Open edges still end in a drop and the claw. The AI releases a drift before it slides onto the off-road.
