...
- Water (Harbour Loop, Boardwalk Nights; Adam, 26 Sept 2026: "does the water behave, look and move like Mario Kart World's"): a real Gerstner swell near the course (art-pipeline waterWaves.ts), semi-translucent from the surface down (shallow turquoise over a visible sandy seabed, fading to opaque deep blue, foam lapping the shoreline and on the highest crests) exactly as Nintendo's own developers describe MKW's sea — "the shoal floor shows through crystal-clear shallow water, deep water reads blue" (Nintendo "Ask the Developer" Vol.18 Pt.3) — and as Digital Foundry's MKW tech review finds in the game itself ("waves have real geometric undulation... with foam on the crests").
