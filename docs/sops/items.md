...
## Constraints
8 items in v1; two slots (held + next), the held one is used first; 15 s start lockout and 8 s final-lap lockout for equalisers; leader always has a defensive option in the table.
