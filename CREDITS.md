...
| Work | Author | License |
|---|---|---|
| Music: 6 original songs (title, 4 race themes, results), made for this game with Eleven Music, Sept 2026 | ElevenLabs Eleven Music, prompts by the Rascal Rally! team | ElevenLabs paid-plan commercial license (Eleven Music terms) |
| Music: the Harbor Loop race theme, an original song made for this game with Google Lyria 3.5, 26 Sept 2026 (it replaced the Eleven Music one) | Google Lyria 3.5 (Gemini API), prompt by the Rascal Rally! team | Gemini API Additional Terms of Service, paid tier: Google claims no ownership of generated content (ai.google.dev/gemini-api/terms) |
