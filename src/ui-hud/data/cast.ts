...
export const CAST: readonly CastCard[] = Object.freeze([
  ...
  { id: 'juniper', name: 'Juniper', archetype: 'medium', species: 'Fox park ranger', personality: 'Cheerful rule-follower, secretly fierce', kart: 'Wood-panel off-roader', accent: '#B7410E', secondary: '#2D6A4F' },
  { id: 'otto', name: 'Otto', archetype: 'medium', species: 'Otter lifeguard', personality: 'Laid-back, waves at everyone', kart: 'Water-scooter kart', accent: '#64B5F6', secondary: '#E53935' },
  ...
  { id: 'gus', name: 'Big Gus', archetype: 'heavy', species: 'Walrus chef', personality: 'Booming laugh, feeds rivals after races', kart: 'Food-truck kart', accent: '#E63946', secondary: '#FFFFFF' },
]);
