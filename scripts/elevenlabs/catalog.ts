 ...
 * with a different cut the second time; docs/sops/audio.md has the full scores), no human voice on
 * three overlapping cuts of the whole song, and its loop seam judged clean. race-harbour, 26 Sept 2026:
 * 9/1/9/9 (polish, cheesiness, melody, brief) against 4-5/7/5/4; its loop (36 bars at 150 BPM after a
 * 12 s intro) judged seamless on two cuts. Its tempo was asked as 152: the bars run at 150.
 * race-frost, 26 Sept 2026: 9/3/9/10 against 2/8/4/3, then (a different cut) 9/2/8/10 against 5/7/5/2;
 * no intro, so its loop runs the whole take (52 bars from 0.2 s); asked at 140 BPM, its bars run at 146.
 * results, 26 Sept 2026: 9/2/8/9 against 2/8/5/3, then 8/3/7/9 against 7/6/5/3 (the shipped file itself
 * read as having vocal chops on that cut, moot since it is being replaced); the take ran to 120 s (asked
 * 32 s) and its first, longest candidate loop (112 s) had an audible seam, so it loops a shorter, clean
